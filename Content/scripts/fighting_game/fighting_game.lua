...
local function Character(face, skin_color, shirt_color, hair_color, shoe_color)
	local self = {
		...
		Create = function(self, face, skin_color, shirt_color, hair_color, shoe_color)
			...
			self.sprite_hpbar_background = Sprite(script_dir() .. "assets/hp_bar.png")
			...
			self.sprite_hpbar_hp = Sprite(script_dir() .. "assets/hp_bar.png")
			...
			self.sprite_hpbar_pattern = Sprite(script_dir() .. "assets/hp_bar.png", script_dir() .. "assets/hp_bar.png")
			...
			self.sprite_hpbar_pattern2 = Sprite(script_dir() .. "assets/hp_bar.png", script_dir() .. "assets/hp_bar.png")
			...
			self.sprite_hpbar_border = Sprite(script_dir() .. "assets/hp_bar.png")
			...
			if(self.face > 0) then
				self.sprite_timer = Sprite(script_dir() .. "assets/hp_bar.png")
