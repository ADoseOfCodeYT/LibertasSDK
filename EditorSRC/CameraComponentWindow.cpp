...
{
	editor = _editor;
	lb::gui::Window::Create(ICON_CAMERA " Camera", lb::gui::Window::WindowControls::COLLAPSE | lb::gui::Window::WindowControls::CLOSE | lb::gui::Window::WindowControls::FIT_ALL_WIDGETS_VERTICAL);
