...
namespace lb::lua
{
	...
	{
		int args = lb::lua::SGetArgCount(L);
		if (args < 3)
		{
			lb::lua::SError(L, "PathQuery::Process(Vector start,goal, VoxelGrid voxelgrid) not enough arguments!");
			return 0;
		}
		Vector_BindLua* start = Luna<Vector_BindLua>::lightcheck(L, 1);
		if (start == nullptr)
		{
			lb::lua::SError(L, "PathQuery::Process(Vector start,goal, VoxelGrid voxelgrid) first argument is not a Vector!");
			return 0;
		}
		Vector_BindLua* goal = Luna<Vector_BindLua>::lightcheck(L, 2);
		if (start == nullptr)
		{
			lb::lua::SError(L, "PathQuery::Process(Vector start,goal, VoxelGrid voxelgrid) second argument is not a Vector!");
			return 0;
		}
		VoxelGrid_BindLua* voxelgrid = Luna<VoxelGrid_BindLua>::lightcheck(L, 3);
		if (voxelgrid == nullptr)
		{
			lb::lua::SError(L, "PathQuery::Process(Vector start,goal, VoxelGrid voxelgrid) third argument is not a VoxelGrid!");
			return 0;
		}
	...
	int PathQuery_BindLua::SearchCover(lua_State* L)
	{
		...
		if (args < 5)
		{
			lb::lua::SError(L, "PathQuery::SearchCover(Vector observer,subject,direction, float max_distance, VoxelGrid voxelgrid) not enough arguments!");
			return 0;
		}
		Vector_BindLua* observer = Luna<Vector_BindLua>::lightcheck(L, 1);
		if (observer == nullptr)
		{
			lb::lua::SError(L, "PathQuery::SearchCover(Vector observer,subject,direction, float max_distance, VoxelGrid voxelgrid) first argument is not a Vector!");
			return 0;
		}
		Vector_BindLua* subject = Luna<Vector_BindLua>::lightcheck(L, 2);
		if (subject == nullptr)
		{
			lb::lua::SError(L, "PathQuery::SearchCover(Vector observer,subject,direction, float max_distance, VoxelGrid voxelgrid) second argument is not a Vector!");
			return 0;
		}
		Vector_BindLua* direction = Luna<Vector_BindLua>::lightcheck(L, 3);
		if (direction == nullptr)
		{
			lb::lua::SError(L, "PathQuery::SearchCover(Vector observer,subject,direction, float max_distance, VoxelGrid voxelgrid) third argument is not a Vector!");
			return 0;
		}
		float max_distance = lb::lua::SGetFloat(L, 4);
		VoxelGrid_BindLua* voxelgrid = Luna<VoxelGrid_BindLua>::lightcheck(L, 5);
		if (voxelgrid == nullptr)
		{
			lb::lua::SError(L, "PathQuery::SearchCover(Vector observer,subject,direction, float max_distance, VoxelGrid voxelgrid) fifth argument is not a VoxelGrid!");
			return 0;
		}
	...
	{
		lb::lua::SSetBool(L, pathquery->is_succesful());
		return 1;
	}
	...
	int PathQuery_BindLua::SetDebugDrawWaypointsEnabled(lua_State* L)
	{
		...
		if (argc < 0)
		{
			lb::lua::SError(L, "PathQuery::SetDebugDrawWaypointsEnabled(bool value) not enough arguments!");
			return 0;
		}
		pathquery->debug_waypoints = lb::lua::SGetBool(L, 1);
		return 0;
	}
	int PathQuery_BindLua::SetFlying(lua_State* L)
	{
		...
		if (argc < 0)
		{
			lb::lua::SError(L, "PathQuery::SetFlying(bool value) not enough arguments!");
			return 0;
		}
		pathquery->flying = lb::lua::SGetBool(L, 1);
		return 0;
	}
	int PathQuery_BindLua::IsFlying(lua_State* L)
	{
		lb::lua::SSetBool(L, pathquery->flying);
		return 1;
	}
	int PathQuery_BindLua::SetAgentHeight(lua_State* L)
	{
		...
		if (argc < 0)
		{
			lb::lua::SError(L, "PathQuery::SetAgentHeight(int value) not enough arguments!");
			return 0;
		}
		pathquery->agent_height = lb::lua::SGetInt(L, 1);
		return 0;
	}
	int PathQuery_BindLua::GetAgentHeight(lua_State* L)
	{
		lb::lua::SSetInt(L, pathquery->agent_height);
		return 1;
	}
	int PathQuery_BindLua::SetAgentWidth(lua_State* L)
	{
		...
		if (argc < 0)
		{
			lb::lua::SError(L, "PathQuery::SetAgentWidth(int value) not enough arguments!");
			return 0;
		}
		pathquery->agent_width = lb::lua::SGetInt(L, 1);
		return 0;
	}
	int PathQuery_BindLua::GetAgentWidth(lua_State* L)
	{
		lb::lua::SSetInt(L, pathquery->agent_width);
		return 1;
	}
	int PathQuery_BindLua::GetWaypointCount(lua_State* L)
	{
		lb::lua::SSetInt(L, (int)pathquery->get_waypoint_count());
		return 1;
	}
	int PathQuery_BindLua::GetWaypoint(lua_State* L)
	{
		...
		if (argc < 1)
		{
			lb::lua::SError(L, "PathQuery::GetWaypoint(int index) not enough arguments!");
			return 0;
		}
	...
	{
		Luna<PathQuery_BindLua>::Register(lb::lua::GetLuaState());
	}
}
