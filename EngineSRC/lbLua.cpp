...
#include "lbRenderer_BindLua.h"
#include "lbAudio_BindLua.h"
#include "lbSprite_BindLua.h"
#include "lbImageParams_BindLua.h"
#include "lbSpriteAnim_BindLua.h"
...
#include "lbTrailRenderer_BindLua.h"
...
namespace lb::lua
{
	...
	void FixedUpdate()
	{
		SignalHelper(lua_internal().m_luaState, "libertasengine_fixed_update_tick");
	}
	void Update()
	{
		SignalHelper(lua_internal().m_luaState, "libertasengine_update_tick");
	}
	void Render()
	{
		SignalHelper(lua_internal().m_luaState, "libertasengine_render_tick");
	}
